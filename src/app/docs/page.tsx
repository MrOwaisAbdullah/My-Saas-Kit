        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              MY SAAS KIT V2 Documentation
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Complete guide to building and deploying AI-powered SAAS
              applications with our comprehensive starter kit
            </p>
            ...
            <section id="overview">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    MY SAAS KIT V2 is a production-ready, feature-complete SAAS
                    starter kit built with Next.js 15, designed to help
                    developers launch AI-powered applications quickly and
                    efficiently.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    This comprehensive starter kit provides everything you need
                    to build a modern SAAS application, including
                    authentication, payment processing, AI integration, user
                    management, and a beautiful responsive interface.
                  </p>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            NextAuth.js with Google OAuth, protected routes,
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            Stripe integration with Pro plan subscriptions,
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            OpenRouter API with multiple AI models, interactive
                            chat interface, and credit-based usage system.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            User analytics, revenue tracking, credit monitoring,
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            Tailwind CSS v4, ShadCN UI components, dark/light
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            Neon PostgreSQL with custom functions, user
            ...
            <section id="installation">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Get your SAAS application running in minutes with these
                    simple steps
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
                        <code className="text-sm">
                          git clone
                          https://github.com/zainulabedeen123/Best-Saas-Kit--V2.git
                          <br />
                          cd Best-Saas-Kit--V2
                        </code>
                      </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                        ...
                        <code>.env.local</code> (see detailed setup below)
                      </p>
                    </div>
            ...
            <section id="setup">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure all integrations and services for your SAAS
                    application
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border-l-4 border-green-500 pl-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            <li>
                              • In your Neon dashboard, go to "Connection
                              Details"
                            </li>
                            <li>• Copy the connection string</li>
                            <li>
                              • Add it to your <code>.env.local</code> as{" "}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border-l-4 border-purple-500 pl-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            ...
                            <li>
                              • Copy webhook secret to <code>.env.local</code>
                            </li>
                          </ul>
                        </div>
                      </div>
...
└── tsconfig.json             # TypeScript configuration`}
                  ...
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="text-sm space-y-1">
                        <li>
                          <code>src/app/</code> - Next.js 15 App Router pages
                          and layouts
                        </li>
                        <li>
                          <code>src/components/</code> - Reusable React
                          components
                        </li>
                        <li>
                          <code>src/lib/</code> - Utility functions and
                          configurations
                        </li>
                        <li>
                    ...
                    <div>
                      ...
                      <ul className="text-sm space-y-1">
                        <li>
                          <code>middleware.ts</code> - Route protection and
                          authentication
                        </li>
                        <li>
                          <code>lib/auth.ts</code> - NextAuth.js configuration
                        </li>
                        <li>
                          <code>lib/database.ts</code> - Database connection and
                          queries
                        </li>
                        <li>
                          <code>lib/stripe.ts</code> - Payment processing
                          utilities
                        </li>
                      </ul>
                    </div>
            ...
            <section id="usage">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    How to use and navigate the different features of your SAAS
                    application
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                          <li>
                            • <strong>Overview:</strong> User stats and quick
                            actions
                          </li>
                          <li>
                            • <strong>Chat:</strong> AI-powered chat interface
                          </li>
                          <li>
                        ...
                        <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                          <li>
                            • <strong>Billing:</strong> Subscription management
                          </li>
                          <li>
                            • <strong>Profile:</strong> User profile management
                          </li>
                          <li>
            ...
            <section id="customization">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    How to customize and extend the application for your
                    specific needs
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
                        <li>
                          • Modify <code>src/app/globals.css</code> for global
                          styles
                        </li>
                        <li>
                          • Update <code>tailwind.config.js</code> for Tailwind
                          customization
                        </li>
                        <li>
                          • Edit components in <code>src/components/ui/</code>{" "}
                          for UI changes
                        </li>
                        <li>
                          • Customize theme colors and fonts in the
                          configuration files
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
                        <li>
                          • Update <code>src/lib/stripe.ts</code> for pricing
                          changes
                        </li>
                        <li>
                          • Modify <code>src/lib/database.ts</code> for database
                          schema changes
                        </li>
                        <li>
                          • Edit <code>src/middleware.ts</code> for route
                          protection
                        </li>
                        <li>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
                        <li>
                          • Change AI models in <code>.env.local</code> (
                          <code>OPENROUTER_MODEL</code>)
                        </li>
                        <li>
                          • Modify chat interface in{" "}
                          <code>src/components/chat/</code>
                        </li>
                        <li>
                          • Update credit costs in{" "}
                          <code>src/lib/database.ts</code>
                        </li>
                        <li>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="border-l-4 border-blue-500 pl-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            ...
                            <li>
                              • Update <code>NEXTAUTH_URL</code> and{" "}
                              <code>NEXT_PUBLIC_SITE_URL</code> to your domain
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="border-l-4 border-blue-500 pl-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            <li>
                              • Vercel will automatically deploy your
                              application
                            </li>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
                        The application can be deployed to any platform that
                        supports Next.js:
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                          <li>
                            • <strong>Netlify:</strong> Use{" "}
                            <code>npm run build</code> and deploy the{" "}
                            <code>.next</code> folder
                          </li>
                          <li>
                            • <strong>Railway:</strong> Connect your GitHub
                            repository
                          </li>
                        </ul>
                        <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                          <li>
                            • <strong>DigitalOcean App Platform:</strong> Use
                            the Next.js template
                          </li>
                          <li>
                            • <strong>AWS Amplify:</strong> Connect your
                            repository and configure build settings
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            <section id="environment">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Complete reference for all required and optional environment
                    variables
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody className="space-y-2">
                        ...
                        <tr className="border-b">
                          ...
                          <td className="py-2">
                            <code>123456789.apps.googleusercontent.com</code>
                          </td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2">
                        ...
                        <tr className="border-b">
                          ...
                          <td className="py-2">
                            <code>qwen/qwen3-235b-a22b-2507</code>
                          </td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2">
                          ...
                          <td className="py-2">
                            <code>re_your-resend-api-key</code>
                          </td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2">
                          ...
                          <td className="py-2">
                            <code>onboarding@yourdomain.com</code>
                          </td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="border border-red-200 dark:border-red-800 rounded-lg p-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            <li>
                              • Check your <code>DATABASE_URL</code> in{" "}
                              <code>.env.local</code>
                            </li>
                        ...
                        <div className="border border-red-200 dark:border-red-800 rounded-lg p-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            <li>
                              • Verify <code>GOOGLE_CLIENT_ID</code> and{" "}
                              <code>GOOGLE_CLIENT_SECRET</code>
                            </li>
                            <li>
                            ...
                            <li>
                              • Ensure <code>NEXTAUTH_URL</code> matches your
                              domain
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="border border-red-200 dark:border-red-800 rounded-lg p-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            <li>
                              • Verify <code>STRIPE_WEBHOOK_SECRET</code> in{" "}
                              <code>.env.local</code>
                            </li>
                            <li>
                        ...
                        <div className="border border-red-200 dark:border-red-800 rounded-lg p-4">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                            <li>
                              • Check <code>OPENROUTER_API_KEY</code> is valid
                            </li>
                            <li>
                              • Verify you have credits in your OpenRouter
                              account
                            </li>
                            <li>
                              • Ensure <code>OPENROUTER_MODEL</code> is
                              available
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
                          <li className="flex items-center gap-2">
                            <ExternalLink className="h-4 w-4 text-blue-500" />
                            <Link
                              href="https://github.com/zainulabedeen123/Best-Saas-Kit--V2/wiki"
                              target="_blank"
                              className="text-blue-600 hover:text-blue-800"
                            >
                              Documentation Wiki
                        ...
                        <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
                          ...
                          <li className="flex items-center gap-2">
                            <ExternalLink className="h-4 w-4 text-blue-500" />
                            <Link
                              href="mailto:support@bestsaaskit.com"
                              className="text-blue-600 hover:text-blue-800"
                            >
                              Email Support
                            </Link>
            ...
            <div className="text-center py-8 border-t">
              ...
              <div className="flex justify-center gap-4 text-sm">
                ...
                <Link
                  href="https://twitter.com/bestsaaskit"
                  target="_blank"
                  className="text-blue-600 hover:text-blue-800"
                >
                  Twitter
